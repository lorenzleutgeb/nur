  ...
  sources = {
    ...
    "n3-1.6.4" = {
      ...
      src = fetchurl {
        ...
        sha512 = "qiiBhW2nJ59cfQzi0nvZs5tSXkXgDXedIy3zNNuKjTwE8Bcvv95DTFJpOY9geg6of5T7z6cg+ZWcaHIij3svrA==";
      };
    };
    "nan-2.14.2" = {
      name = "nan";
...
in {
  ...
  firebase-tools = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "elnmwj+/+psPpHULsiD6Vaezv9R7JYlC/weAmCTOWNky3+ZY0UqG/grquF+nFdwCtqknWESCMvzWRPxcc8Tl+w==";
    };
    dependencies = [
      ...
      (sources."cacheable-request-6.1.0"
        // {
          dependencies = [sources."get-stream-5.2.0" sources."lowercase-keys-2.0.0"];
        })
      ...
      (sources."compression-1.7.4"
        // {
          dependencies = [sources."bytes-3.0.0" sources."debug-2.6.9" sources."ms-2.0.0"];
        })
      ...
      (sources."google-gax-1.12.0"
        // {
          dependencies = [sources."@grpc/grpc-js-0.6.18" sources."semver-6.3.0"];
        })
      ...
      (sources."morgan-1.10.0"
        // {
          dependencies = [sources."debug-2.6.9" sources."depd-2.0.0" sources."ms-2.0.0"];
        })
      sources."ms-2.1.2"
      ...
      (sources."string-width-2.1.1"
        // {
          dependencies = [sources."ansi-regex-3.0.0" sources."strip-ansi-4.0.0"];
        })
      ...
      (sources."winston-3.3.3"
        // {
          dependencies = [sources."async-3.2.0" sources."readable-stream-3.6.0"];
        })
